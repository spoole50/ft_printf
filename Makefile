...
FILES = ft_printf.c ft_vasprintf.c node_init.c arg_node.c modifier.c is_checks.c is_checks2.c str_tasks.c mod_string.c mod_assist.c width_prec.c num_tasks.c
